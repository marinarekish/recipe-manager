...
and apply migrations (see `docs/runbooks/backend-runbook.md` for full details):
...
- one-time 6-digit code. See `docs/auth/auth-flow.md` for the full
  design.
...
- Error responses use the Result pattern — see `docs/architecture/result-convention.md`.
- Full API reference: **`docs/api/api.md`**
- Auth flow details: **`docs/auth/auth-flow.md`**
...
(see `docs/runbooks/backend-runbook.md`).
...
| Document                    | Contents                               |
| --------------------------- | -------------------------------------- |
| `docs/runbooks/backend-runbook.md`     | Backend setup, migrations, conventions |
| `docs/api/api.md`                      | Full REST API contract                 |
| `docs/auth/auth-flow.md`               | Passwordless login design              |
| `docs/architecture/result-convention.md` | Result pattern → HTTP mapping       |
| `docs/architecture/domain_model.md`    | Entity relationships                   |
